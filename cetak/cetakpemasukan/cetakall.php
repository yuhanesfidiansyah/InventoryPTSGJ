...
<body>
  <div name="a" id="a">
    <link rel="stylesheet" type="text/css" href="../../karre.css">
  <br><center><<h2>Laporan Barang Masuk</h2> 
         ...
         <br>
            <table width="1000px" border='0' cellpadding='5' align='center' cellspacing="0" >
                ...
                <tbody align="center">
                  <?php
            $no=1;
            $sql="SELECT barang.barcode, barang.merk_barang, barang.nama_barang, pemasukan.*, det_pemasukan.* from ((barang inner join pemasukan on pemasukan.id_barang=barang.id_barang) inner join det_pemasukan on pemasukan.id_pemasukan=det_pemasukan.id_pemasukan)ORDER BY pemasukan.tanggal";
