...
<body>
  ...
  <br><center><<h2>Laporan Barang Masuk</h2> 
         ...
         <br>
            ...
            <table width="1000px" border='0' cellpadding='10' align='center' cellspacing="0">
                <thead>
                 ...
                 <th bgcolor="#b5b4b1">No</th>
                    ...
                    <th bgcolor="#b5b4b1">Barang Masuk</th>
            ...
            $sql="SELECT barang.*, det_pemasukan.* from barang, pemasukan where det_pemasukan.id_det_pemasukan='$id_det_pemasukan' order by det_pemasukan.id_det_pemasukan";
