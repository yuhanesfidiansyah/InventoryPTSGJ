...
<body>
  ...
  <br><center><<h2>Laporan Pengeluaran Barang</h2> 
         ...
         <br>
            ...
            <table width="1000px" border='0' cellpadding='10' align='center' cellspacing="0">
                <thead>
                 <tr>
                    ...
                    <th bgcolor="silver">Admin</th>
                    <th bgcolor="silver">Barcode</th>
                    <th bgcolor="silver">Merk Barang</th>
                    <th bgcolor="silver">Nama Barang</th>
                    <th bgcolor="silver">Jumlah Pengeluaran Barang</th>
            ...
            $sql="SELECT user.username, barang.barcode, barang.nama_barang, barang.merk_barang, pemasukan.*, pengeluaran.* FROM user, barang, pemasukan, pengeluaran WHERE pemasukan.id_barang=barang.id_barang AND pengeluaran.id_user=user.id_user AND pemasukan.id_pemasukan=pengeluaran.id_pemasukan AND pengeluaran.id_pengeluaran='$id_pengeluaran' ORDER BY pengeluaran.tanggal";
          ...
          ?>
            ...
            <p align="right">
            <label>Mengetahui
            <br>Staff Tata Usaha TIK</label>
            <br><br><br><br><br>
            <strong>Mba UMI</strong>
            </p>
          </div>
          <br>
