...
<div class="judul">Data Barang Masuk</div>
  <table width="1000px" border="0">
      ...
      <?php
      $no=1;
      $sql="SELECT barang.barcode, barang.merk_barang, barang.nama_barang, det_pemasukan.* from ((barang inner join pemasukan on pemasukan.id_barang=barang.id_barang) inner join det_pemasukan on pemasukan.id_pemasukan=det_pemasukan.id_pemasukan) ";
